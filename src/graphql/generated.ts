...
export type Events = Entity & Node & {
  ...
  /** User that created this document */
  createdBy?: Maybe<User>;
  dateEvent: Scalars['String']['output'];
  /** Get the document in other stages */
...
export type EventsCreateInput = {
  ...
  createdAt?: InputMaybe<Scalars['DateTime']['input']>;
  dateEvent: Scalars['String']['input'];
...
export type EventsManyWhereInput = {
  ...
  createdAt_not_in?: InputMaybe<Array<InputMaybe<Scalars['DateTime']['input']>>>;
  createdBy?: InputMaybe<UserWhereInput>;
  dateEvent?: InputMaybe<Scalars['String']['input']>;
  /** All values containing the given string. */
  dateEvent_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values ending with the given string. */
  dateEvent_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are contained in given list. */
  dateEvent_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** Any other value that exists and is not equal to the given value. */
  dateEvent_not?: InputMaybe<Scalars['String']['input']>;
  /** All values not containing the given string. */
  dateEvent_not_contains?: InputMaybe<Scalars['String']['input']>;
  /** All values not ending with the given string */
  dateEvent_not_ends_with?: InputMaybe<Scalars['String']['input']>;
  /** All values that are not contained in given list. */
  dateEvent_not_in?: InputMaybe<Array<InputMaybe<Scalars['String']['input']>>>;
  /** All values not starting with the given string. */
  dateEvent_not_starts_with?: InputMaybe<Scalars['String']['input']>;
  /** All values starting with the given string. */
  dateEvent_starts_with?: InputMaybe<Scalars['String']['input']>;
